...
CREATE TABLE `venta_producto` (
  `VENTAS_PRODUCTO_ID` int NOT NULL AUTO_INCREMENT,
  `PRODUCTO_ID` int NOT NULL,
  `CANTIDAD` int NOT NULL,
  `PRECIO_UNIDAD` decimal(10,0) NOT NULL,
  `VENTA_ID` int NOT NULL,
  PRIMARY KEY (`VENTAS_PRODUCTO_ID`),
  KEY `fk_VENTA_PRODUCTO_VENTA_idx` (`VENTA_ID`),
  KEY `fk_VENTA_PRODUCTO_PRODUCTO_idx` (`PRODUCTO_ID`)
...
INSERT INTO `venta_producto` VALUES (0,2,1,45,0);
